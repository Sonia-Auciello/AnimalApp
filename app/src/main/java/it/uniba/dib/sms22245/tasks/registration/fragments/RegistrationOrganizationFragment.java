package it.uniba.dib.sms22245.tasks.registration.fragments;

import it.uniba.dib.sms22245.tasks.registration.RegistrationActivity;
import it.uniba.dib.sms22245.tasks.registration.dialogs.DialogAddAddress;
...
public class RegistrationOrganizationFragment extends Fragment implements DialogAddAddress.DialogAddAddressListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnRegistration.setOnClickListener(v -> {
            ...
            Spinner spin = (Spinner) view.findViewById(R.id.spinnerPurpose);
            String[] options = getResources().getStringArray(R.array.spinnerItems);
            ArrayAdapter aa = new ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, options);
            aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            String purpose = (String) (spin)
                    .getSelectedItem();
