package it.uniba.dib.sms22245.tasks.passionate.fragments;
...
import it.uniba.dib.sms22245.tasks.passionate.PassionateNavigationActivity;
import it.uniba.dib.sms22245.tasks.passionate.dialogs.DialogAddAnimalFragment;
import it.uniba.dib.sms22245.tasks.passionate.dialogs.DialogEditAnimalDataFragment;
import it.uniba.dib.sms22245.adapters.animals.AnimalListAdapter;
import it.uniba.dib.sms22245.adapters.MessageListAdapter;
import it.uniba.dib.sms22245.entities.operations.InfoMessage;
...
import it.uniba.dib.sms22245.utils.RecyclerTouchListener;
...
public class PassionateProfileFragment extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        LinearLayout linearLayout = rootView.findViewById(R.id.PokAnimal);
        linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavController navController = Navigation.findNavController(view);
                navController.navigate(R.id.action_passionate_profile_to_passionatePokAnimalList);
            }
        });
