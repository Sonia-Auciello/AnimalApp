...
import it.uniba.dib.sms22245.tasks.organization.OrganizationNavigationActivity;
import it.uniba.dib.sms22245.tasks.passionate.PassionateNavigationActivity;
import it.uniba.dib.sms22245.tasks.registration.RegistrationActivity;
import it.uniba.dib.sms22245.tasks.veterinarian.VeterinarianNavigationActivity;
...
import it.uniba.dib.sms22245.utils.InputFieldCheck;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRecoverPassword = findViewById(R.id.txtRecoverPassword);
    ...
    public void txtRecoverPasswordAction(View view){
        btnRecoverPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivity.this, LoginRecoverPasswordFragment.class);
